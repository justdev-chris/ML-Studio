...
private:
    ...
    bool parseTracks(const QJsonArray& tracks, Project* project, const QString& projectPath);
    bool parseTrack(const QJsonObject& trackJson, Track* track, const QString& projectDir);
    bool parseAudioClip(const QJsonObject& clipJson, Clip* clip, const QString& projectDir);
    ...
    QString resolvePath(const QString& relativePath, const QString& baseDir);
};
